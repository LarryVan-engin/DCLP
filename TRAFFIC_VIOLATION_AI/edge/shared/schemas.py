...
class ViolationPacket(BaseModel):
    ...
    full_frame_a_base64: Optional[str] = None      # Ảnh toàn khung SẠCH — thấy đèn + bối cảnh
    full_frame_b_base64: Optional[str] = None      # Ảnh toàn khung CÓ CHÚ THÍCH — bbox + loại lỗi
