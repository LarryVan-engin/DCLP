# File này dùng để chấm Benchmark CULane với model đã train được
# Cách dùng:
# 1. Train model với config exp10 (hoặc config nào đó mà bạn muốn
# 2. Chạy file này với command: python test_CULane.py --exp_dir ./experiments/exp10
# Tuy nhiên nó sẽ chạy qua hết tất cả các batch của test set, 
# nên sẽ mất một khoảng thời gian khá lâu (khoảng 1-2 tiếng tùy vào máy tính của bạn)
